...
1. Select the **Tasks** list.
    ...
    ![Screenshot of SharePoint trigger.](images/sharepoint-trigger.png)
...
1. Enter `approval` in search.
    ...
    ![Screenshot of approvals search.](images/search-approval.png)
...
1. Select **Title** under **New Task**.
    ...
    ![Screenshot of dynamic content for SharePoint item.](images/sharepoint-dynamic-content.png)
...
1. Select **See More**, select **Link to item**.
    ...
    ![Screenshot of Approval action step.](images/start-approval-action.png)
...
1. Enter `/` into the left **Choose a value** field and select **Insert dynamic content**.
    ...
    ![Screenshot of dynamic content for a condition.](images/add-condition.png)
...
1. Select the right **Choose a value** field and enter `Approve`
    ...
    ![Screenshot of the condition.](images/condition.png)
...
1. Select the **Approvals** tab from the left navigation menu.
    ...
    ![Screenshot of approvals in the portal.](images/approvals.png)
